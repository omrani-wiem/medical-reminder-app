        ...
        <div style={{
          ...
          >
            <h1 style={{
              ...
              Votre <span style={{ color: '#fbbf24' }}>santé</span> entre de bonnes mains
            </h1>
            <p style={{
              fontSize: '1.2rem',
              lineHeight: '1.6',
              ...
              Ne manquez plus jamais vos médicaments. Medical Reminder vous accompagne 
              dans votre suivi médical avec des rappels intelligents et un suivi personnalisé.
            </p>
        ...
        <div style={{
          ...
          >
            <h2 style={{
              ...
              Pourquoi choisir Medical Reminder ?
            </h2>
            <p style={{
              fontSize: '1.3rem',
              color: '#64748b',
              ...
              Une solution complète pour ne plus jamais oublier vos médicaments
            </p>
          </div>
          ...
          <div style={{
            ...
            {[
              {
                icon: 'track_changes',
                title: 'Rappels Précis',
                description: 'Notifications automatiques à l\'heure exacte de vos prises'
              },
              {
                icon: 'analytics',
                title: 'Suivi Détaillé',
                description: 'Analysez vos habitudes et visualisez votre progression'
              },
              {
                icon: 'security',
                title: 'Données Sécurisées',
                description: 'Vos informations médicales protégées selon les normes'
              },
              {
                icon: 'lightbulb',
                title: 'Interface Simple',
                description: 'Design intuitif accessible à tous les âges'
              },
              {
                icon: 'devices',
                title: 'Multi-plateformes',
                description: 'Accès depuis tous vos appareils, partout'
              },
              {
                icon: 'money_off',
                title: '100% Gratuit',
                description: 'Aucun coût caché, service entièrement gratuit'
              }
            ].map((avantage, index) => (
              <div
                key={index}
        ...
        <div style={{
          ...
          >
            ...
            <p style={{
              ...
              Découvrez toutes les fonctionnalités qui rendent Medical Reminder unique
            </p>
          </div>
          ...
          >
            ...
            >
              ...
              <p style={{
                ...
                Recevez des notifications automatiques par email à l'heure exacte de vos prises. 
                Notre système vérifie toutes les minutes pour garantir que vous ne manquez aucun médicament.
              </p>
              <ul style={{
                listStyle: 'none',
                padding: 0,
                ...
                {[
                  { icon: 'email', text: 'Notifications par email automatiques' },
                  { icon: 'schedule', text: 'Vérification toutes les minutes' },
                  { icon: 'settings', text: 'Personnalisation des horaires' },
                  { icon: 'repeat', text: 'Rappels récurrents' }
                ].map((item, i) => (
                  <li key={i} style={{
                    fontSize: '1.1rem',
                    color: '#64748b',
          ...
          >
            ...
            >
              ...
              <p style={{
                ...
                Analysez votre observance thérapeutique avec des statistiques détaillées. 
                Visualisez vos progrès et identifiez les habitudes à améliorer.
              </p>
              <ul style={{
                listStyle: 'none',
                padding: 0,
                ...
                {[
                  { icon: 'trending_up', text: 'Statistiques de progression' },
                  { icon: 'event', text: 'Historique des prises' },
                  { icon: 'track_changes', text: 'Objectifs personnalisés' },
                  { icon: 'assignment', text: 'Rapports détaillés' }
                ].map((item, i) => (
                  <li key={i} style={{
                    fontSize: '1.1rem',
                    color: '#64748b',
          ...
          >
            ...
            >
              ...
              <p style={{
                ...
                Chiffrement de bout en bout et respect total de votre vie privée.
              </p>
              <ul style={{
                listStyle: 'none',
                padding: 0,
                ...
                {[
                  ...
                  { icon: 'local_hospital', text: 'Conformité normes médicales' },
                  { icon: 'lock', text: 'Authentification sécurisée' },
                  { icon: 'cloud_done', text: 'Stockage sécurisé' }
                ].map((item, i) => (
                  <li key={i} style={{
                    fontSize: '1.1rem',
                    color: '#64748b',
        ...
        <div style={{
          ...
          >
            ...
            <p style={{
              ...
              Rejoignez des milliers d'utilisateurs qui ont déjà amélioré leur observance thérapeutique. 
        ...
        <div style={{
          ...
          <div style={{
            ...
            >
              ...
              >
                La plateforme de référence pour le suivi médical personnalisé. 
                Prenez soin de votre santé en toute simplicité.
              </p>
              <div
                id="footer-social"
                data-animate
          ...
          >
            <p style={{ margin: 0, fontSize: '0.9rem' }}>
              © 2025 Medical Reminder. Tous droits réservés. | 
              Développé avec ❤️ pour votre santé
            </p>
          </div>
        </div>
      </footer>
